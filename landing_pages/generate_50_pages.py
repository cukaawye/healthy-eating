...
# Expanded Headlines for 50 variations
headlines_base = [
    ...
    "Fuel Your Body Without the Kitchen Stress: The Lazy Cook's Method",
    "Healthy Eating, Finally Simplified: 75 Recipes for a New You",
    "The 21-Day Clean Eating Challenge: Simple Recipes for Beginners",
    "Eat Better, Live Better, Stress Less: The Lazy Cook's Handbook",
    "Vibrant Health in Under 15 Minutes: The Lazy Cook's Secret",
    "The Beginner's Roadmap to Clean Eating & Lasting Energy",
    "Summer 2026 Reset: Master Clean Eating with These Simple Recipes",
    "Your Personalized Wellness Journey Starts Here: The Lazy Cook's Guide",
    "The Simple Way to Clean Eating Success: 75 Delicious Recipes",
